...
router.route('/').post(function(req, res, next) {
	...
	if (req.body.emprunt_retour == undefined) {
		...
		sql = "INSERT INTO frequentation (jour_semaine, date, heure, consult_place, vne, vna, vacances, id_lecteurs, type_action, nbr_doc1, type_doc1, cat_doc1, mdl_doc1, ppm) VALUES ('"+req.body.jour+"', '"+req.body.date+"', '"+req.body.hours+"', '"+req.body.consult_place+"', '"+req.body.vne+"', '"+req.body.vna+"', '"+req.body.vacances+"', '"+req.body.lecteur+"', '"+req.body.emprunt_retour+"', '"+req.body.nombre1+"', '"+req.body.type1+"', '"+req.body.categorie1+"', '"+req.body.mdl_checkbox1+"', '"+req.body.presence+"')";
	}
